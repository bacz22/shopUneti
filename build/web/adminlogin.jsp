...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            /* Ẩn icon mặc định của trình duyệt Edge/Chrome */
            input::-ms-reveal,
            input::-ms-clear {
                display: none;
            }

            /* === CSS Nút ẩn hiện mật khẩu cho Admin === */
            .password-toggle {
                position: absolute;
                right: 15px;
                top: 50%; /* Căn giữa theo chiều dọc của khung input */
                transform: translateY(-50%);

                background: transparent;
                border: none;
                color: #888;
                z-index: 20; /* Cao hơn z-index của input group để bấm được */
                padding: 5px;
                cursor: pointer;
                display: flex;
                align-items: center;
