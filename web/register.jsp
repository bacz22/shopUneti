...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            /* === CSS Nút ẩn hiện mật khẩu (Đã chỉnh sửa chuẩn) === */
            .password-toggle {
                position: absolute;
                right: 15px;
                top: 57px; /* Căn chuẩn theo chiều dọc của icon bên trái */
                transform: translateY(-50%); /* Căn giữa tâm */
            ...
            /* Quan trọng: Giữ nguyên vị trí khi hover để không bị tụt */
    ...
    <body>
        ...
        <script>
            // Hàm bật/tắt hiển thị mật khẩu (Dùng chung cho cả 2 ô)
